...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo13-addon-account_bank_statement_clearing_account',
        'odoo13-addon-account_bank_statement_import_adyen',
        ...
        'odoo13-addon-account_bank_statement_import_online_adyen',
