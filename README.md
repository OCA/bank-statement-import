...
[account_statement_import_txt_xlsx](account_statement_import_txt_xlsx/) | 15.0.2.0.2 | [![alexey-pelykh](https://github.com/alexey-pelykh.png?size=30px)](https://github.com/alexey-pelykh) | Import TXT/CSV or XLSX files as Bank Statements in Odoo
