...
class OnlineBankStatementProvider(models.Model):
    ...
    def _ponto_retrieve_data(self, date_since, date_until):
        ...
        backwards, until we find data that has a transaction date before date_since,
        ...
        while transactions:
            for line in transactions:
                ...
                if (
                        (
                            is_scheduled
                            and identifier == self.ponto_last_identifier
                        )
                        or (
        ...
        # We get here if we found no transactions before date_stop,
    ...
    def _ponto_get_transaction_datetime(self, transaction):
        """Get datetime for a transaction.
